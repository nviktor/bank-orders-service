...
{
	/// <summary>
	/// Database       : orderservice_lm_db
	/// Data Source    : tcp://localhost:5432
	/// Server Version : 11.2
	/// </summary>
	internal partial class OrderServiceDbContext : LinqToDB.Data.DataConnection
	{
		public ITable<Order>        Orders        { get { return this.GetTable<Order>(); } }
		public ITable<OrderContext> OrderContexts { get { return this.GetTable<OrderContext>(); } }
	...
	{
		[Column("id",           DataType=DataType.Guid),                                  PrimaryKey, NotNull] public Guid           Id          { get; set; } // uuid
		[Column("applicant_id", DataType=DataType.Int32,          Precision=32, Scale=0),             NotNull] public int            ApplicantId { get; set; } // integer
		[Column("state",        DataType=DataType.NVarChar,       Length=32),                         NotNull] public string         State       { get; set; } // character varying(32)
		[Column("date_add",     DataType=DataType.DateTimeOffset, Precision=6),                       NotNull] public DateTimeOffset DateAdd     { get; set; } // timestamp (6) with time zone
		[Column("product_id",   DataType=DataType.Int32,          Precision=32, Scale=0),             NotNull] public int            ProductId   { get; set; } // integer

		#region Associations

		/// <summary>
		/// fk_order_context_order_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="OrderId", CanBeNull=true, Relationship=Relationship.OneToOne, IsBackReference=true)]
		public OrderContext Fkcontext { get; set; }
	...
	{
		[Column("order_id",            DataType=DataType.Guid),                 PrimaryKey,  NotNull] public Guid   OrderId           { get; set; } // uuid
		[Column("ip",                  DataType=DataType.NVarChar, Length=64),     Nullable         ] public string Ip                { get; set; } // character varying(64)
		[Column("utm",                 DataType=DataType.Text),                    Nullable         ] public string Utm               { get; set; } // text
		[Column("google_analytics_id", DataType=DataType.Text),                    Nullable         ] public string GoogleAnalyticsId { get; set; } // text
		[Column("region",              DataType=DataType.NVarChar, Length=256),    Nullable         ] public string Region            { get; set; } // character varying(256)
		[Column("browser",             DataType=DataType.Text),                    Nullable         ] public string Browser           { get; set; } // text
		[Column("browser_user_agent",  DataType=DataType.Text),                    Nullable         ] public string BrowserUserAgent  { get; set; } // text

		#region Associations

		/// <summary>
		/// fk_order_context_order
		/// </summary>
		[Association(ThisKey="OrderId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.OneToOne, KeyName="fk_order_context_order", BackReferenceName="Fkcontext")]
	...
	{
		[Column(DataType=DataType.Int64,     Precision=64, Scale=0), NotNull    ] public long      Version     { get; set; } // bigint
		[Column(DataType=DataType.DateTime2, Precision=6),              Nullable] public DateTime? AppliedOn   { get; set; } // timestamp (6) without time zone
		[Column(DataType=DataType.NVarChar,  Length=1024),              Nullable] public string    Description { get; set; } // character varying(1024)
	}
